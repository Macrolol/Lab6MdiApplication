...
'Date modified: April 11 2020
'Description:
' This is a very basic text editor application. It allows
' the user to edit save and load text files.
...
#Region "Event Handlers"
    ...
    ''' <param name="e"></param>
    Friend Sub mnuHelpAbout_Click(sender As Object, e As EventArgs) Handles mnuHelpAbout.Click
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub frmTextEdit_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        If Me.MdiParent IsNot Nothing Then 'do I have a parent
            mnuMainStrip.Visible = False ' 
        End If
    End Sub
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuNew_Click(sender As Object, e As EventArgs)
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuOpen_Click(sender As Object, e As EventArgs) Handles mnuOpen.Click

        If ConfirmClose() Then 'You really want to close what you've got?
            'declare variables for the FileStream and FileWriter
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuCopy_Click(sender As Object, e As EventArgs)
        If txtMainBox.SelectionLength <> 0 Then
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuCut_Click(sender As Object, e As EventArgs) Handles mnuCut.Click
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuPaste_Click(sender As Object, e As EventArgs) Handles mnuPaste.Click
    ...
    Friend Function mnuSave_Click() As Boolean Handles mnuSave.Click
        ...
        Else
            Return mnuSaveAs_Click() 'return the save as event which will save on a specified path
        End If
    ...
    ''' </summary>
    ''' <returns>True if it saves, false if it does not</returns>
    Friend Function mnuSaveAs_Click() As Boolean Handles mnuSaveAs.Click
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub mnuExit_Click(sender As Object, e As EventArgs) Handles mnuExit.Click
        Me.Close()
    End Sub
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Friend Sub txtMainBox_TextChanged(sender As Object, e As EventArgs) Handles txtMainBox.TextChanged
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub frmTextEdit_FormClosing(sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
        e.Cancel = True
...
#Region "Functions"
    ...
    Friend Function ConfirmClose() As Boolean
        ...
        If fileChanged Then 'has the file been changed since last save?
            ...
            If response = vbYes Then ' what did they choose?
                If Not mnuSave_Click() Then 'did they press cancel on the save dialog?
